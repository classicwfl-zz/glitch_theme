    ...
    <div class="glitch_container">
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <a href="<?php echo esc_url(get_permalink()) ?>" class="glitch_imageListItem" style="background-image: url('<?php 
                ...
                echo $thumb_url;
            ?>');">
                <div class="glitch_imageListTitle"><h2 class="glitch_termType fontSize_md fontWeight_norm font_lowercase"><?php echo glitch_convertToTermType(get_the_title()); ?>.pdf</h2></div>
            </a>
        <?php endwhile; endif; ?>
